---
name: research-paper-writing-finite
...
metadata:
  hermes:
    ...
    category: research
    related_skills: [arxiv-finite, ml-paper-writing-finite, subagent-driven-development-finite, plan-finite]
...
**Load the `arxiv-finite` skill** for structured paper discovery: `skill_view("arxiv-finite")`. It provides arXiv REST API search, Semantic Scholar citation graphs, author profiles, and BibTeX generation.
...
|-------|-------------|-------------|
| **arxiv-finite** | Phase 1 (Literature Review): searching arXiv, generating BibTeX, finding related papers via Semantic Scholar | `skill_view("arxiv-finite")` |
| **subagent-driven-development-finite** | Phase 5 (Drafting): parallel section writing with 2-stage review (spec compliance then quality) | `skill_view("subagent-driven-development-finite")` |
| **plan-finite** | Phase 0 (Setup): creating structured plans before execution. Writes to `.hermes/plans/` | `skill_view("plan-finite")` |
...
**This skill supersedes `ml-paper-writing-finite`** — it contains all of ml-paper-writing-finite's content plus the full experiment/analysis pipeline and autoreason methodology.
